	...
	if(e.getSource() == B4)
 	    ...
 	    else if(e.getSource() == B2)
 		 {
                 try 
                 {
                    ...
                    //String prec;
                    Statement st = con.createStatement();
                    ResultSet res = st.executeQuery("SELECT * FROM PRODUTO WHERE ID = " + idi);
                    if(res.next()) 
                    { 
         	          Tx2.setText(res.getString("Vinho"));
         	          Tx3.setText(res.getString("Cor"));
         	          Tx4.setText(res.getString("Preco"));
                       Tx2.disable();
                       Tx3.disable();
                       Tx4.disable();
         	          B22.setVisible(true);
               ...
               sqlex.printStackTrace();
  	       ...
  	       else if(e.getSource() == B22)
                 {
                    try 
                    {
                       ...
                       Statement st = con.createStatement();
                       st.executeUpdate("DELETE FROM PRODUTO WHERE ID = " + iddeli);
           ...
           else if(e.getSource() == B33)
                {
                   try 
                   {
                      ...
                      Statement st = con.createStatement();
                      st.executeUpdate("UPDATE PRODUTO SET Vinho = '"+ Tx2.getText() +"',Cor = '"+ Tx3.getText() +"', Preco = "+ preco +" WHERE ID = " + idalt);                           

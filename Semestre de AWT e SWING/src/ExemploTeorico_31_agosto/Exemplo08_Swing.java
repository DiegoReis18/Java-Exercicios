package ExemploTeorico_31_agosto;
...
public class Exemplo08_Swing extends JFrame  implements ActionListener
{
JButton B1, B2, B3, B4, B5;
JLabel L1;
		
public Exemplo08_Swing()
{
   ...
   {
      new Exemplo08_Swing().setVisible(true);
   }
   ...
   public void actionPerformed(ActionEvent e)
   {
      if (e.getSource() == B5)
         ...
         if (e.getSource() == B1)
         {
        	 Exemplo08_Swing obj = new Exemplo08_Swing();
	       obj.setVisible(true);
         }
         else
            if (e.getSource() == B2)
